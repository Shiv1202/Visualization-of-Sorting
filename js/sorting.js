var sorting = (function() {
    ...
    var SWAP_COLOR = ' #7094db';
     ...
     function AnimatedArray(ary, canvas, interval) {
        ...
        /*
        * An AnimatedArray wras a pure Javascript array of numbers,
        * and provides function to compare and swap elements of the array. 
        * These comparisons and swaps will br visualized on a canvas.
        ...
        * array id immediately updated and the action is added to the action list;
        ...
        * is updated if needed, and the array is drwan to the canvas.
        * 
        * This design lets clients of AnimatedArray use it in clean imperative
        * code without worrying about callbacks. The downside is that is uses
        * extra memory.
        * 
        * Inputes to the constructor:
        *  - ary: Puer Javascript array to wrap
        *  - canvas: DOM canvas object wher we will draw 
        *  - intervel: Time (in milliseconds) between visualizing each step
        */
     ...
     AnimatedArray.prototype.compare = function (i, j) {
         /*
         * Compare the elements at indices i ans j.
         *
     ...
     function perm_to_swaps(perm) {
         ...
         * perm[i].
         * 
         * In general any permutation can be written as a product off
     ...
     function heapsort(aa, left, right) {
         ...
         // Now pop element one by one, rebuilding the heap after each
         var end = right;
         while(end > left) {
             aa.swap(end, left);
             end--;
     ...
     var algorithms = {
         ...
         'mergesort' : mergesort,
         'introsort' : introsort,
         'bitonic_mergesort' : bitonic_meregsort
     }
